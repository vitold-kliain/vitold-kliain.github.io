(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('aos'), require('jquery'), require('scrollmonitor'), require('swiper'), require('jarallax'), require('@tanem/svg-injector')) :
  typeof define === 'function' && define.amd ? define(['exports', 'aos', 'jquery', 'scrollmonitor', 'swiper', 'jarallax', '@tanem/svg-injector'], factory) :
  (global = global || self, factory(global.theme = {}, global.AOS, global.jQuery, global.scrollMonitor, global.Swiper, global.jarallax, global.SVGInjector));
}(this, function (exports, AOS, jQuery, scrollMonitor, swiper, jarallax$1, svgInjector) { 'use strict';
  ...
  (function () {
    ...
    var SELECTOR_FADE = 'js-fade-page';
  ...
  (function ($) {
    if (typeof jarallax$1 === 'function') {
      $('.alert-dismissible').on('closed.bs.alert', function () {
        jarallax$1(document.querySelectorAll('[data-jarallax]'), 'onScroll');
      });
      $(document).on('resized.mr.overlayNav', function () {
        jarallax$1(document.querySelectorAll('[data-jarallax]'), 'onResize');
      });
      ...
      $(window).on('load', function () {
        ...
        jarallax$1(document.querySelectorAll('[data-jarallax-delay]'), jarallaxOptions);
      });
    }
  })(jQuery);
  ...
  (function ($) {
    $('.js-canvas-toggle').on('click', function () {
      ...
      $('.navbar .navbar-nav .nav-item').toggleClass('slide-in'); // if ($('body').hasClass('is-mobile-menu-visible')) {
  ...
  var mrSticky = function ($) {
    ...
    function () {
      ...
      _proto.onWatcherChange = function onWatcherChange($element) {
        ...
        $element.toggleClass(ClassName.SCROLLED, this.watcher.isAboveViewport && !this.stickBottom); // Fix to bottom when element enters via bottom of viewport and has data-sticky="bottom"
